...
exports.createResultSet = (query, data, adjustForPagination = true) => {
...
exports.createResultSetItem = (query, doc, fields) => {
    ...
    prev[name] = {
      get() {
        ...
        if ($value != null && field.isEmbedded()) {
          ...
          $value = exports.createResultSet(newQuery, map($value, v => exports.createResultSetItem(newQuery, v, newFields)), false);
        }
